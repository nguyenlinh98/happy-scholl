                ...
                <div class="row">
                    ...
                    <div class="col-8 p-0">
                        ...
                        <div class="upload-btn-wrapper">
                            ...
                            <img id="img-choose" src="{{ asset('storage\image-advertises/'.$advertise->filename) }}" alt="your image"/>
                        </div>
                        <br><br>
                            ...
                            <div class="row pr-5">
                                <div class="col-6 p-0">
                                    ...
                                    <div class="date-pick mb-1">
                                        <input class="pl-0" type="text" name="startdate" value="{{$advertise->startdate}}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="date-pick mb-1">
                                        <input class="pl-0" type="text" name="enddate" value="{{$advertise->enddate}}"
                                               style="padding-left: 10px!important; padding-top: 5px; padding-bottom: 5px; font-weight: bold">
                                    </div>
                                </div>
                            </div>
