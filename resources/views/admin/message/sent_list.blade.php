    ...
    <table class="table datatable" id="messages_table" data-controller="datatable">
        <thead>
            <tr class="datatable--header--row">
                ...
                <th scope="col" class="datatable--header--cell" data-sortable="false" style="width: 150px;">詳細</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{route('admin.message.edit', $message)}}" class="btn btn-edit btn-sm"><span class="text-middle fs-btn-edit">詳細確認</span></a></td>
