...
@slot('action', route('admin.require_feedback.confirm', $requireFeedback))
@slot('title')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2">
    <h2>回答必要通知</h2>
</div>
<div class="form--title px-4 py-3 mb-3 rounded--lg bg-primary d-inline-block h1">配信予約一覧</div>
@endslot
