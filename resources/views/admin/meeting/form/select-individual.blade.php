<div class="form-group pt-2">
    <div role="individual_select" data-controller="individual-select" class="individual-select" data-individual-select-students-api="{{ route('admin.meeting.select_people') }}" data-individual-select-defaults='{{ old('individual_receivers', $meeting->individual_receivers ?: '[]') }}'>
